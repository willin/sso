      ...
      <main className='w-[720px] max-w-full mx-auto shadow bg-base-100/90 p-2 sm:p-4 mb-20'>
        ...
        <footer className='text-center text-sm mt-4'>
          <p>
            ...
            <a href='https://github.com/willin/sso' target='_blank' className='inline-block' rel='noreferrer'>
              <img alt='GitHub Repo stars' src='https://img.shields.io/github/stars/willin/sso?style=social' />
            </a>
          </p>
          <p>
            &copy;{' '}
